...
cout<<"\t\t\t\t\t@@|                                  WELCOME TO                                           |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                          LABAID HOSPITAL MANAGEMENT SYSTEM                                  |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
...
if(i==5){
	system("cls");
	cout<<" Md. Abdul Hamid,\t MBBS.\n";
	cout <<"Speacialist in surjery.\n";
	cout <<"\n";
	
	cout <<"Md Hasan Mahmud,\t MBBS \n";
	cout <<"Speacialist in Obstetrician/gynecologists\n";
	cout <<"\n";
	
	cout <<"Md Tanjimul Haque,\t MBBS\n";
	cout <<"speacialist in Ophthalmologists\n";
	cout <<"\n";
	
	cout <<"Dr. Saki Mohammad Jakiul Alam \n";
    cout <<" MBBS, FCPS (MEDICINE) \n";
    cout <<"Medicine Specialist \n";
    cout <<"\n";
    
    cout <<"Dr. Ishrat Binte Reza\n";
    cout <<"MBBS, FCPS (MEDICINE), MACP (USA)\n";
    cout <<"Medicine Specialist\n";
    cout <<"\n";
    
    cout <<" Dr. Abed Hussain Khan\n";
    cout <<"MBBS, FCPS (MEDICINE)\n";
    cout <<"Medicine (All Diseases of Adults) Specialist\n";
    cout <<"\n";
    
    cout <<" Dr. Md. Mahbubul Alam\n";
    cout <<"MBBS, MCPS (Medicine), MD ( Neurology)\n";
    cout <<"Neurology (Brain, Stroke, Nerve, Headache, Migraine) Specialist\n";
    cout <<"\n";
    
    cout <<" Dr. Md. Ruhul Quddus\n";
    cout <<"MBBS, FCPS (Medicine), MD (Neurology)\n";
    cout << "Neurology (Brain, Stroke, Nerve, Migraine) & Medicine Specialist";
    cout <<"\n";
    
    
    cout <<" Prof. Dr. Ahsan Habib (Helal)\n";
    cout <<"MBBS, MD (Neurology)\n";
    cout <<"Neurology (Brain, Stroke, Parkinson's & Movement Disorder) Specialist\n";
    cout <<"\n";
    
    cout <<" Dr. M M Zaman\n";
    cout <<"MBBS, FCPS, FIAS, MACR, MAAPMR, MAARM (USA)\n";
    cout <<" Physical Medicine, Interventional Pain, Arthritis & Spine Specialist\n";
    cout <<"\n";
